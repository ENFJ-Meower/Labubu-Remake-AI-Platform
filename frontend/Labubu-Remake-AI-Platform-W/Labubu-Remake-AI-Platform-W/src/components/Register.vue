    ...
    <div class="register-container">
      ...
      <form class="register-form" @submit.prevent="handleRegister">
        ...
        <div class="form-group form-group-inline">
          ...
          <input type="text" id="code" v-model="code" placeholder="请输入验证码" style="width: 120px;" />
          <button type="button" class="code-btn" disabled>获取验证码</button>
        </div>
